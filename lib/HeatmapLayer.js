...
exports.default = (0, _reactLeaflet.withLeaflet)((_temp = _class = function (_MapLayer) {
  ...
  HeatmapLayer.prototype._computeAggregate = function _computeAggregate(agg, pointCount, intensity, aggregateType) {
    var mean = function mean(m, c, value) {
      return m + (value - m) / c;
    };
  ...
  HeatmapLayer.prototype.redraw = function redraw() {
    ...
    var accumulateInGrid = function accumulateInGrid(points, leafletMap, bounds, aggregateType) {
      return (0, _lodash4.default)(points, function (grid, point) {
        ...
        var agg = computeAggregate(aggregates[key].data, aggregates[key].seen, intensity, aggregateType);
  ...
  aggregateType: _propTypes2.default.oneOf(['Mean', 'Count', 'Sum'])
}, _temp));
